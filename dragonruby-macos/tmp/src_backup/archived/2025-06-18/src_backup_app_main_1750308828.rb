def tick args
  args.state.star ||= { x: 640,
                       ...
                       source_x: 100,      # Start further in to skip transparent padding
                       source_y: 100,      # Start further in to skip transparent padding
                       source_w: 800,     # Use the actual star width (adjust as needed)
                       source_h: 753,     # Use the actual star height (adjust as needed)
                       dx: 5,
                       dy: 5}
