def tick args
  args.state.star ||= { x: 640,
                       ...
                       #source_x: 60,      # Start further in to skip transparent padding
                       #source_y: 60,      # Start further in to skip transparent padding
                       source_w: 710,     # Use the actual star width (adjust as needed)
                       source_h: 710,     # Use the actual star height (adjust as needed)
                       dx: 5,
                       dy: 5}
